...
over_3_days_btn = InlineKeyboardButton(text='Истекут в ближайшие 3 дня', callback_data='3_daysCD') # Кнопка выводящая товару, где срок проходиит в течение 3 дней
over_15_days_btn = InlineKeyboardButton(text='Истекут в ближайшие 15 дней', callback_data='15_daysCD') # Кнопка выводит товар, гдже срок годности кончается в течение 15 дней
...
in_db_keyboard = InlineKeyboardMarkup(inline_keyboard=([add_product_btn], [del_product_btn], [show_products_btn], [over_3_days_btn], [over_15_days_btn], [exit_DB_btn], [calculation_btn])) # Клавиатура кнопок взаимодействия с БД
